...
export const CATEGORIES: Category[] = ['Books', 'Notes', 'Lab Equipment', 'Electronics', 'Others'];
...
export const INITIAL_RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    description: 'Handwritten notes covering Linear Regression to Neural Networks. Very detailed.',
    category: 'Notes',
    ownerId: 'user_3',
    ownerName: 'Rahul V.',
